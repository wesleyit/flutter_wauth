...
ThemeData defaultTheme() {
  return ThemeData(
      ...
      textTheme: TextTheme(
        ...
        headline2: TextStyle(
            fontSize: 24.0, fontWeight: FontWeight.w500, color: myYellow),
        headline5: TextStyle(
            fontSize: 22.0, fontWeight: FontWeight.w900, color: myPurple),
        bodyText1: TextStyle(
            fontSize: 20.0, fontWeight: FontWeight.w500, color: myBlack),
      ));
}
